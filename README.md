...
> **A modern, elegant financial center and personal expense tracker built with Flask, Tailwind CSS, and Supabase PostgreSQL.**
...
**SpendWise** is a full-featured personal finance and expense tracking web application. Designed with modern Material 3 design principles, fluid glassmorphism accents, and responsive UI components, SpendWise gives users complete control over their cashflow, budgets, spending habits, and financial analytics.

Powered by a robust **Flask** backend with **SQLAlchemy 2.0**, SpendWise seamlessly connects to **Supabase PostgreSQL** for cloud-native persistence with automatic connection pooling and local SQLite fallback.
...
- 💸 **Transaction Management**:
  - Add, filter, search, and delete expenses and incomes.
  - Multi-attribute tracking: Merchant/Payee, Amount, Category, Payment Method (UPI, Card, Net Banking, Cash), Date, Time, and Notes.
- 📈 **Visual Analytics & Charts**:
  - Interactive category spending breakdown with percentage distribution.
  - Cashflow trends and monthly burn analysis.
- 📅 **Calendar Daily Heatmap**:
  - Month-at-a-glance view aggregating day-by-day outflows.
- 🔍 **Advanced Filtering & Search**:
  - Instant client-side search across descriptions, categories, and date ranges.
- 📥 **Export Reports**:
...
- ☁️ **Supabase Cloud Native**:
  ...
  - Zero-config fallback to local SQLite for offline development.
...
- **Frontend**: Vanilla JavaScript (Modular ES6), HTML5, Tailwind CSS, Google Material Symbols, Chart.js
...
├── static/
│   ├── css/
│   │   └── style.css            # Custom CSS animations & typography
│   └── js/
│       ├── api.js               # Centralized REST API client
│       ├── app.js               # Application coordinator & state
│       ├── auth.js              # Authentication & user profile logic
│       ├── calendar.js          # Calendar view & daily outflow aggregation
│       ├── charts.js            # Chart.js analytics & visual breakdowns
